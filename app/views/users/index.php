...
<body class="flex items-center justify-center min-h-screen p-4">
  ...
  <div class="container card mx-auto p-6 lg:p-10 w-full">
    ...
    <div class="flex justify-between items-center mb-6 flex-wrap gap-4">
      ...
      <a href="<?=site_url('auth/logout'); ?>" class="btn-danger">Logout</a>
    </div>
    ...
    <div class="flex justify-between items-center mb-8 flex-wrap gap-4">
      ...
      <a href="<?=site_url('users/create'); ?>" class="btn-primary flex items-center shadow-md hover:scale-105">
